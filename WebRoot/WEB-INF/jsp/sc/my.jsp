    ...
    <div class="width1200 center_yh hidden_yh">
        ...
        <div id="vipRight">
            <div class="hidden_yh bj_fff" style="width: 938px;border: 1px solid #ddd;">
                <div class="width100 font24" style="height: 60px;line-height: 60px;text-indent: 30px;background: #f5f8fa;border-bottom: 1px solid #ddd;">
                    最近收藏
                </div>
                    ...
                    <c:forEach items="${pagers.datas}" var="data" varStatus="l">
                        <a href="${ctx}/item/view?id=${data.itemId}">
                            <div class="width100 hidden_yh" style="border-bottom: 1px dashed #ddd;padding-top: 10px;padding-bottom: 10px;">
                                <img src="${data.item.url1}" width="100px" height="100px" class="left_yh">
                                <div class="left_yh" style="width: 580px;margin-left: 15px;margin-top: 10px">
                                    <h3 class="font18 c_33 font100">${data.item.name}</h3>
                                    <p class="red" style="margin-top: 10px;">￥${data.item.price}</p>
                                </div>
                                <div class="right_yh">
                                    <a href="${ctx}/sc/delete?id=${data.id}" class="onfff block_yh tcenter font16" style="margin-top: 15px;padding: 6px;">取消收藏</a>
                                </div>
                            </div>
                        </a>
                    </c:forEach>
