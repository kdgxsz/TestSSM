...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px">
    <div class="width1200 center_yh hidden_yh">
        ...
        <div id="vipRight">
            <form action="${ctx}/user/uexUpdate" method="post" id="myf">
                <div class="hidden_yh bj_fff" style="width: 938px;border: 1px solid #ddd;">
                    <div class="width100 font24" style="height: 60px;text-indent: 50px;background: #f5f8fa;border-bottom: 1px solid #ddd;line-height: 60px">基本信息</div>
                    ...
                    <div class="width100" style="height: 32px;line-height: 32px;margin: 35px 0px;">
                        <a href="javascript:void(0)" class="left_yh block_yh font16 tcenter ff5802" id="sub" style="width: 222px;height: 33px;line-height: 33px;margin-left: 110px">保存</a>
                    </div>
                </div>
            </form>
        </div>
