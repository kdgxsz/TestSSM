...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px">
    <div class="width1200 center_yh hidden_yh">
        ...
        <div id="vipRight">
            <div class="font24"
                 style="height: 60px;line-height: 60px;text-indent: 30px;background: #f5f8fa;border-bottom: 1px solid #ddd;">
                修改密码
            </div>
            ...
            <div class="bj_fff hidden_yh" style="width: 838px;border: 1px solid #ddd;margin-top: 30px;padding: 50px;">
                <div class="width100" style="height: 32px;line-height: 32px;">
                    ...
                    <input type="password" id="jiu"
                           style="width: 243px;border: 1px solid #ddd;outline: none;margin-left: 10px;height: 30px;text-indent: 10px;">
                </div>
