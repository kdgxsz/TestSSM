...
<div class="width1198 center_yh" style="height: 420px">
    <div class="left_yh" style="width: 350px;height: 420px">
        ...
        <div id="preview">
            <div>
                <img src="${obj.url1}" alt="" height="350px" width="350px">
            </div>
            <div id="spec-list" style="margin: 25px 0px">
                <ul class="list-h">
                    <li><img src="${obj.url2}" alt=""></li>
                    <li><img src="${obj.url3}" alt=""></li>
                    <li><img src="${obj.url4}" alt=""></li>
                    <li><img src="${obj.url5}" alt=""></li>
                </ul>
            </div>
        </div>
    </div>
...
<div type="" class="width1200 hidden_yh center_yh" style="margin-top: 60px">
    <div class="right_yh" style="width: 1200px">
        ...
        <div class="width100 hidden_yh" style="margin: 20px 5px">
            <div id="spDetail">
                ${obj.ms}
            </div>
            <div id="spPj">
               <div class="width100 hidden_yh" style="padding-bottom: 20px;border-bottom: 1px dashed #ddd;margin-bottom: 10px;">
                   <c:forEach items="${obj.pls}" var="data" varStatus="l">
                       <div style="width: 790px;float: right;overflow: hidden;margin-top: 20px">
                           <img src="${ctx}/resource/user/images/x.jpg" style="width: 40px;height: 40px;border-radius: 50%;float: left;border: 1px solid #ddd;margin-top: 20px;margin-right: 25px">
