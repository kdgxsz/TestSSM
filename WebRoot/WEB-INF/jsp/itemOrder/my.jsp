        ...
        <div id="vipRight">
            <div style="width: 938px;border: 1px solid #ddd;background: #fff;">
                <div class="width100 hidden_yh" style="height: 74px;line-height: 74px;background: #f5f8fa;border-bottom: 1px solid #ddd;" id="navLt">
                    ...
                    <span class="left_yh font24 width20 tcenter cursor onHover onoran20">已取消(${fn:length(yqx)})</span>
                </div>

                <!--全部订单-->
                <div class="allGoods width100 hidden_yh hhD" style="display: block;">
                    <c:forEach items="${all}" varStatus="l" var="data">
                        <div class="width100 hidden_yh">
                            ...
                            <c:forEach items="${data.details}" var="chil" varStatus="l">
                                <div style="width: 838px;border-bottom: 1px solid #ddd;padding-top: 30px;padding-bottom: 30px;" class="hidden_yh center_yh">
                                    <img src="${chil.item.url1}" width="100px" height="100px" class="left_yh" style="padding-right: 10px" alt="">
                                    <div class="left_yh" style="width: 580px">
                                        <h3 class="font18 c-33 font100">${chil.item.name}</h3>
                                        <p class="c_66 font16" style="margin-top: 16px;">折扣:<span class="red">${chil.item.zk}</span>折</p>
                                        <p class="red" style="margin-top: 10px;">￥${chil.item.price}元</p>
                                    </div>
                                    <div class="right_yh">
                            ...
                            <div style="width: 838px;padding-top: 30px;padding-bottom: 30px;" class="hidden_yh center_yh tleft">
                                ...
                                <font class="font24 red">￥${data.total}元</font>
                ...
                <div class="allGoods width100 hidden_yh hhD" style="display: none;">
                    <c:forEach items="${dfh}" varStatus="l" var="data">
                        <div class="width100 hidden_yh">
                            <div class="width100 hidden_yh font20 c_66" style="background: #faf5f5;text-indent: 47px;height: 50px;line-height: 50px;border-bottom: 1px solid #ddd;">
                                <fmt:formatDate value="${data.addTime}" type="both"/>&nbsp;&nbsp;订单号${data.code}
                                <c:if test="${data.status==0}">待发货</c:if>
                ...
                <!--待收货订单-->
                <div class="allGoods width100 hidden_yh hhD" style="display: none;">
                    <c:forEach items="${dsh}" varStatus="l" var="data">
                        <div class="width100 hidden_yh">
                            <div class="width100 hidden_yh font20 c_66" style="background: #faf5f5;text-indent: 47px;height: 50px;line-height: 50px;border-bottom: 1px solid #ddd;">
                                <fmt:formatDate value="${data.addTime}" type="both"/>&nbsp;&nbsp;订单号${data.code}
                                <c:if test="${data.status==0}">待发货</c:if>
                ...
                <!--已收货订单-->
                <div class="allGoods width100 hidden_yh hhD" style="display: none;">
                    <c:forEach items="${ysh}" varStatus="l" var="data">
                        <div class="width100 hidden_yh">
                            <div class="width100 hidden_yh font20 c_66" style="background: #faf5f5;text-indent: 47px;height: 50px;line-height: 50px;border-bottom: 1px solid #ddd;">
                                <fmt:formatDate value="${data.addTime}" type="both"/>&nbsp;&nbsp;订单号${data.code}
                                <c:if test="${data.status==0}">待发货</c:if>
                ...
                <!--已取消订单-->
                <div class="allGoods width100 hidden_yh hhD" style="display: none;">
                    <c:forEach items="${yqx}" varStatus="l" var="data">
                        <div class="width100 hidden_yh">
                            <div class="width100 hidden_yh font20 c_66" style="background: #faf5f5;text-indent: 47px;height: 50px;line-height: 50px;border-bottom: 1px solid #ddd;">
                                <fmt:formatDate value="${data.addTime}" type="both"/>&nbsp;&nbsp;订单号${data.code}
                                <c:if test="${data.status==0}">待发货</c:if>
