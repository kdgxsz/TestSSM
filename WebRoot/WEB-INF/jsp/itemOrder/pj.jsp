        ...
        <div id="vipRight">
            ...
            <form action="${ctx}/comment/exAdd" method="post" id="myf">
                ...
                <div class="bj_fff hidden_yh" style="width: 838px;height: 120px;border: 1px solid #ddd;margin-top: 30px;padding: 50px;">
                    <div class="width100">
                        <div class="left_yh font16 tright" style="width: 120px;height: 32px;line-height: 32px;">
                            <font class="red">*</font>评价内容:
                        </div>
                        <textarea name="content" rows="10" cols="30" style="width: 300px;height: 100px;border: 1px solid #ddd;text-indent: 10px;margin-left: 5px;">
                        </textarea>
                    </div>
                    <div class="width100" style="height: 40px;line-height: 40px;margin-top: 22px;">
                        <a href="javascript:void(0)" class="left_yh block_yh font16 tcenter ff5802 con" style="width: 240px;height: 33px;line-height: 33px;margin-left: 140px;">保存</a>
                    </div>
                </div>
            </form>
        </div>
