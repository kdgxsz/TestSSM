...
<div class="width100" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipRight" style="width: 1200px">
            <div class="font24" style="height: 60px;line-height: 60px;text-indent: 30px;background: #f5f8fa;border-bottom: 1px solid #ddd;">
                公告列表
            </div>
    ...
    <div class="pagelist " style="text-align: center;margin-top: 10px;" >
        <!--分页开始-->
        <!--maxIndexPages 最大输出页码数 maxPageItems 每页显示的行数(默认是10)-->
        <pg:pager url="${ctx}/news/list" maxIndexPages="5" items="${pagers.total}"
